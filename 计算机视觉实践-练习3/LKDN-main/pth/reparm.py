...
dict = torch.load('experiments/self_training/LKDN-S_adan_x4_scratch_L1_fine_tune_L2/models/LKDN-S_del_x4.pth')
...
torch.save(dict, 'experiments/self_training/LKDN-S_adan_x4_scratch_L1_fine_tune_L2/models/LKDN-S_del_rep_x4.pth')

dict = torch.load('experiments/self_training/LKDN-S_adan_x4_scratch_L1_fine_tune_L2/models/LKDN-S_del_rep_x4.pth')
